...
export interface ApplicationCommandInteraction {
    command: discord.SlashCommandBuilder | discord.SlashCommandOptionsOnlyBuilder | discord.SlashCommandSubcommandsOnlyBuilder | Omit<discord.SlashCommandBuilder, "addSubcommand" | "addSubcommandGroup">;
